...
function getForm(){
	...
	xhr.open("GET", "http://localhost:8080/TuitionReimb/supform?formid="+formid,true);
	xhr.send();
}
...
function postForm(){
    ...
    xhr.open("POST","http://localhost:8080/TuitionReimb/supform",true);
...
function getAmt(){
	...
	xhr.open("GET", "http://localhost:8080/TuitionReimb/supAD?Userid="+Userid,true);
	xhr.send();
}
