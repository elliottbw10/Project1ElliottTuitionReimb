...
function getForm(){
	...
	xhr.open("GET", "http://localhost:8080/TuitionReimb/OverForm?formid="+formid,true);
	xhr.send();
}
...
function postForm(){
    ...
    xhr.open("POST","http://localhost:8080/TuitionReimb/OverForm",true);
...
function getAmt(){
	...
	xhr.open("GET", "http://localhost:8080/TuitionReimb/OverAd?Userid="+Userid,true);
	xhr.send();
}
